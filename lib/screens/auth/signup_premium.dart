...
class SignUpPremiumScreen extends StatefulWidget {
  ...
  @override
  _SignUpPremiumScreenState createState() => _SignUpPremiumScreenState();
}

class _SignUpPremiumScreenState extends State<SignUpPremiumScreen> {
  String _username;
  String _email;
  String _password1;
  String _password2;
  ...
  void _createUser() async {
    ...
    var result = await AuthService().signupPremium(
      email: _email,
