...
class SignupPremiumCryptoPay extends StatefulWidget {
  ...
  @override
  _SignupPremiumCryptoPayState createState() => _SignupPremiumCryptoPayState();
}

class _SignupPremiumCryptoPayState extends State<SignupPremiumCryptoPay> {
  AppConfigModel app;
  String _payTo;
