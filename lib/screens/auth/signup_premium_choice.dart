...
import 'signup_premium_crypto_pay.dart';
import 'signup_premium.dart';
...
class SignupPremiumChoice extends StatefulWidget {
  @override
  _SignupPremiumChoiceState createState() => _SignupPremiumChoiceState();
}

class _SignupPremiumChoiceState extends State<SignupPremiumChoice> {
  String _username;
  int countryCode = 226;
    ...
    if (result != null && result.error == null) {
      if (result.status == 'Pending' || result.status == 'Waiting') {
        ...
        Navigator.of(context).push(
          CubePageRoute(
            enterPage: SignupPremiumCryptoPay(
              username: '$_username',
            ...
            exitPage: SignupPremiumCryptoPay(
              username: '$_username',
              countryCode: countryCode,
              countryFlag: countryFlag,
              length: localNumberLength,
