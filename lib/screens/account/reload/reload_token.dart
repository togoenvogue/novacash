...
class ReloadTokenScreen extends StatefulWidget {
  @override
  _ReloadTokenScreenState createState() => _ReloadTokenScreenState();
}

class _ReloadTokenScreenState extends State<ReloadTokenScreen> {
  dynamic _amount;
      ...
      if (result.error == null) {
        CustomAlert(
          ...
          colorText: Colors.black,
            ...
            context,
            'Succès!',
            '$_amount FCFA ont été crédités avec succès sur votre compte avec un NovaToken',
            false);
        // delay, redirect
